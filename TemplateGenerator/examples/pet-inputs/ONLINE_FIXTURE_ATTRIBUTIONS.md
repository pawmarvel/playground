# Online fixture image attributions

These images are development fixtures for offline transformation and composition
QA. Their source and license metadata is also pinned in the release fixture-set
manifest. Keep this file with the image inventory when copying the fixtures.

| Local file | Source | Creator | License | Modifications |
| --- | --- | --- | --- | --- |
| `french-bulldog.jpg` | [French Bulldog brindle standing](https://commons.wikimedia.org/wiki/File:French_Bulldog_brindle_standing.jpg) | danny O. | [CC BY 2.0](https://creativecommons.org/licenses/by/2.0) | None; original file bytes. |
| `greyhound.jpg` | [Greyhound standing side-on](https://commons.wikimedia.org/wiki/File:Greyhound_standing_side-on.jpg) | Chaoticfluffy | [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0) | None; original file bytes. |
